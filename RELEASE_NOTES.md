...
- Adds explicit Android 13+ predictive Back handling inside the native video player.
- Back from native video now follows the app's Minimize player on Back setting instead of letting the system finish the video Activity unexpectedly.
