...
android {
    ...
    defaultConfig {
        // Keep the existing release application ID so 2.2.4 upgrades the signed stable app.
        applicationId = "com.addy37.crazyshitunofficial"
        minSdk = 26
        targetSdk = 35
        versionCode = System.getenv("APP_VERSION_CODE")?.toIntOrNull() ?: 28
        versionName = System.getenv("APP_VERSION_NAME") ?: "2.2.4"
    }
