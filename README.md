...
**Requirements:** Android 8.0 (API 26) or newer. New stable builds and checksums are on [GitHub Releases](https://github.com/Addy37/CrazyShitAndroid/releases). Earlier fixed download URLs for `CrazyShit.apk` and `ZeroFilter.apk` remain as compatibility aliases for the same signed release APK.
