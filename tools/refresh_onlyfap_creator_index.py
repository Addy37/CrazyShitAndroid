...
collects source-confirmed creator names from configured creator listings/search,
merges them with the reviewed seed already in the APK, and writes a compact
name/alias TSV.
